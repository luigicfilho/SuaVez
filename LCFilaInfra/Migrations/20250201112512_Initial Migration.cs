        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkLogodaEmpresa = table.Column<string>(type: "TEXT", nullable: false),
                    CorPrincipalEmpresa = table.Column<string>(type: "TEXT", nullable: false),
                    CorSegundariaEmpresa = table.Column<string>(type: "TEXT", nullable: false),
                    FooterEmpresa = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdAdminEmpresa = table.Column<Guid>(type: "TEXT", nullable: false),
                    EmpresaConfiguracaoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Ativo = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpresasLogin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmpresasLogin_EmpresaConfigs_EmpresaConfiguracaoId",
                        column: x => x.EmpresaConfiguracaoId,
                        principalTable: "EmpresaConfigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TempoMedio = table.Column<string>(type: "TEXT", nullable: false),
                    Tipofila = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Filas_EmpresasLogin_EmpresaLoginId",
                        column: x => x.EmpresaLoginId,
                        principalTable: "EmpresasLogin",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    FiladePessoasId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    FilaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Nome = table.Column<string>(type: "TEXT", nullable: false),
                    Documento = table.Column<string>(type: "TEXT", nullable: false),
                    Celular = table.Column<string>(type: "TEXT", nullable: false),
                    Ativo = table.Column<bool>(type: "INTEGER", nullable: false),
                    Preferencial = table.Column<bool>(type: "INTEGER", nullable: false),
                    Posicao = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    FilaPessoaId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmpresasLogin_EmpresaConfiguracaoId",
                table: "EmpresasLogin",
